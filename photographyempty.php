...
<li><a href="mainhomeempty.php">HOME</a></li>
  ...
  <li><a href="photographyempty.php" class="active">PHOTOGRAPHY</a></li>
...
<center>
<div class="polaroid">
  <img src="photo.jpg" alt="Norway" width="20" height="190" style="width:100%">
  <div class="container">
    <p>PHOTOS</p>
  </div>
</div>
...
function myFunction() {
    ...
    if (confirm("please Login") == true) {
        ...
        window.location.href="photographyempty.php";
    }
