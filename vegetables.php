...
<input type="hidden" name="hosted_button_id" value="Z5C8A8HZN84PS">
...
<div class="polaroid">
  ...
  <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="TAN7EHFEWM666">
<button style="width:100%;"> <p>ADDTOCART</p></button>
</form>
...
<div class="polaroid">
  ...
  <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="9HE489STMV7RQ">
<button style="width:100%;"> <p>ADDTOCART</p></button>
</form>
</div>
...
<div class="polaroid">
  ...
  <div class="container">
    <p>GARLIC</p>
	<label>GM</label><input type="number" min="100" max="500" step="50" value="0">
  </div>
  <button style="width:100%;"> <p>ADDTOCART</p></button>
</div>
...
<div class="polaroid">
  ...
  <div class="container">
    <p>TOMATO</p>
	<label>KG</label><input type="number" min="1" max="9" step="1" value="0">
  </div>
  <button style="width:100%;"> <p>ADDTOCART</p></button>
</div>
